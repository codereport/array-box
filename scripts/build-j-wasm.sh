...
#
# This builds J (from jsoftware/jsource master) to WebAssembly
# using Emscripten inside a Docker container. The output files
# (emj.js, emj.wasm, emj.data) are placed in wasm/j/.
#
...
echo "=========================================="
echo "  Building J WASM for Array Box"
echo "=========================================="
echo ""
echo "This will build J to WebAssembly using Docker + Emscripten."
...
ls -lh "$WASM_DIR"
echo ""
echo "J WASM module is ready to use."
